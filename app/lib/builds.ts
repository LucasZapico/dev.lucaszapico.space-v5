  ...
  "investment-platform": {
    ...
    highlights: [
      ...
      },
      {
        ...
        body: "Market data comes from Alpaca, Binance, CoinGecko, and GeckoTerminal, each with different schemas, update frequencies, and reliability characteristics. Binance WebSocket volume data broke mid-project and was replaced. Collectors run continuously and gap fillers detect and backfill missing windows. Data quality checks run before training: minimum history requirements, gap detection, volume coverage thresholds. Garbage data in means garbage models out.",
      },
    ],
    links: [],
  },
